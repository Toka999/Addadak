...
import ElectricityBadge from "../components/ElectricityBadge";
        ...
        <>
            ...
            <section className="mt-20 flex flex-col gap-15 ">
                ...
                <div className="getStarted flex justify-center">
                    <button className="bg-blue duration-300 py-5 px-5 rounded rounded-20 text-my-white border border-black font-bold hover:bg-my-white hover:text-black hover:cursor-pointer" >Get started - Register </button>
                </div>
